...
| `framework` | 🟢 livre | — (ff0d68b2 fechou em 15/08: **CC-86**, `src/dependencias.mjs` + `cc deps`. 73 arquivos em 23ms; platform.mjs tem 16 dependentes e alcanca 32 por tabela. Ligado ao recado do CC-84) | — |

...
| `cockpit` | 🟢 livre | — (ff0d68b2 fechou em 15/08: **CC-83**, os tres niveis de backlog no mapa, com o do meio derivado de quem tem agente. Anterior: CC-81 e CC-78) | — |
...
| `framework` | 🟢 livre | — (ff0d68b2 fechou em 15/08: **CC-68**, metodos `conserto` (reproduzir antes, provar depois) e `estudo` (a entrega e a decisao, codigo travado nas 2 fases). Dado puro: zero linha no motor) | — |

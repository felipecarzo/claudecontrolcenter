...
| `framework` | 🟢 livre | — (ff0d68b2 em 16/08: mais 3 camadas da Bancada, todas SEM ferramenta externa — `segredo-historico` (git log -G), `service-role` e `tls` (node:tls, dominios vindos do nginx da VPS). 7 de 19 rodam) | — |

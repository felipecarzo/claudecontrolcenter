...
| `cockpit` | 🟢 livre | — (ff0d68b2 em 16/08: **CC-87 fechado**, as 11 telas respondem uma pergunta cada, mais a VPS que inaugurou. `hooks` agrupa por nivel e `tempo` encolhe no estreito. Falta a consideracao dele, tela a tela) | — |
...
| `framework` | 🟢 livre | — (ff0d68b2 em 15/08: o **restritivo parou de travar codigo** — erro meu, copiei o `trava` do sugestivo; o escopo dele e a ROTA. Sintoma: ele desligou o framework 3x numa tarde. Mais CC-90 (gate de pergunta) e CC-91 registrado) | — |

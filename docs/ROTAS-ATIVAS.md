...
| `framework` | 🟢 livre | — (ff0d68b2 em 16/08: **Bancada**, catalogo inteiro com 19 camadas (4 rodam, 15 declaradas) e `cc bancada rodar <camada>`. Declarada recusa com honestidade em vez de fingir) | — |

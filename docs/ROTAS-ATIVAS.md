...
| `framework` | 🟢 livre | — (ff0d68b2 fechou em 15/08: as duas correcoes dele na analise — relacoes no lugar de glossario solto, e o Daily que eu tinha cortado errado — mais CC-84 (agentes se falando, URGENTE, ele poe 2 agentes amanha) e CC-85 (log das conversas)) | — |

...
| `framework` | 🟢 livre | — (ff0d68b2 em 16/08: o **restritivo ganhou fluxo declarado** — pedido novo vira item e a execucao continua; so para no que so ele decide. Injetado a cada sessao. Anterior: 3 camadas da Bancada) | — |

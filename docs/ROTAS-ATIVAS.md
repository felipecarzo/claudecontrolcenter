...
| `front` | 🟢 livre | — (fbabdeb0 fechou em 25/08: **CC-341**, o seletor de framework no cartão de projeto de outra máquina, no lugar da frase morta, com o pedido pendente visível. Provado em navegador, sem exceção. Só acrescentou bloco novo; nada do que 1d765cd1 fez hoje cedo foi tocado) | — |
